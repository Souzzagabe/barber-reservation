...
-- AddForeignKey
ALTER TABLE "Booking" ADD CONSTRAINT "Booking_barbershopServiceId_fkey" FOREIGN KEY ("barbershopServiceId") REFERENCES "BarbershopService"("id") ON DELETE SET NULL ON UPDATE CASCADE;
